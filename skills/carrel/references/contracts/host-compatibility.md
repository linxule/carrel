...
| Claude Cowork | Likely High (unverified) | Sessions and schedules can run remotely. Connected local folders are reachable only while Claude Desktop is open on that computer; this skill pack has not yet been exercised end-to-end in Cowork, so treat compatibility as provisional. |
