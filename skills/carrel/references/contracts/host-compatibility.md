...
| Claude Cowork | Likely High (unverified) | Runs in a local sandboxed VM with file read/write and code execution, closer to Claude Code's model than bare Desktop chat — but this skill pack has not yet been installed and exercised inside a real Cowork session. Treat as provisional until verified. |
